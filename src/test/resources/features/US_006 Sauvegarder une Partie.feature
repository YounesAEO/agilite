...
Feature: US_006 Sauvegarder une Partie
  En tant que joueur, je voudrais sauvegarder une partie que j'ai terminé 
  afin de consulter le résultat plus tard

  Scenario Outline: Sauvegarder la partie terminée par le joueur
    Given Une partie
    And Un match entre équipe joueur <equipe1> et équipe adverse <equipe2> 
    avec la date <dateSauvegarde>
